...
Pokémon and all related names, characters, and assets are trademarks of Nintendo, Game Freak, 
and The Pokémon Company. I do not claim ownership of any Pokémon intellectual property. 

Only the original code and artwork created specifically for this mod are licensed under the 
MIT License (see LICENSE file). This project is not affiliated with, endorsed by, or 
